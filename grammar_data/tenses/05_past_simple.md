...
| make | made | speak | spoke | know | knew |
...
| ❌ Sai | ✅ Đúng | Giải thích |
|-------|---------|-----------|
| She **didn't went** there. | She **didn't go** there. | Sau `did/didn't` → V nguyên thể |
...
[
  {
    "type": "fill_blank",
    "prompt": "My family ___ (visit) my grandparents last weekend.",
    "answer": "visited",
    "explanation": "'Last weekend' là thời điểm xác định trong QK → Past Simple. visit → visited (thêm -ed)."
  },
  {
    "type": "fill_blank",
    "prompt": "She ___ (not / go) to the party because she ___ (feel) unwell.",
    "answer": "didn't go, felt",
    "explanation": "'Didn't go': phủ định Past Simple → didn't + V nguyên thể. 'Felt': V2 bất quy tắc của 'feel'."
  },
  {
    "type": "multiple_choice",
    "prompt": "When ___ you ___ learning to drive?",
    "options": ["did / began", "did / begin", "do / begin", "have / begun"],
    "answer": "did / begin",
    "explanation": "Câu hỏi Past Simple: Did + S + V nguyên thể? 'Begin' là V nguyên thể (V2 của begin là began, nhưng sau did luôn dùng V nguyên thể)."
  },
  {
    "type": "multiple_choice",
    "prompt": "She ___ a very interesting book when she was a child.",
    "options": ["has written", "wrote", "was writing", "writes"],
    "answer": "wrote",
    "explanation": "'When she was a child' → thời điểm xác định trong QK → Past Simple. 'write' → V2 bất quy tắc 'wrote'."
  },
  {
    "type": "multiple_select",
    "prompt": "Which sentences are grammatically CORRECT Past Simple?",
    "options": [
      "They didn't arrived on time.",
      "He spoke three languages fluently.",
      "Did she went to the market?",
      "We had a great time at the festival last summer.",
      "I didn't know the answer."
    ],
    "answer": ["He spoke three languages fluently.", "We had a great time at the festival last summer.", "I didn't know the answer."],
    "explanation": "'Didn't arrived' → phải là 'didn't arrive'. 'Did she went' → phải là 'Did she go' (V nguyên thể sau Did)."
  },
  {
    "type": "reorder",
    "prompt": "Arrange the words to form a correct sentence:",
    "words": ["two", "ago", "years", "He", "Japan", "moved", "to"],
    "answer": "He moved to Japan two years ago.",
    "explanation": "'Two years ago' là thời điểm xác định → Past Simple. 'Ago' luôn đứng sau khoảng thời gian."
  },
  {
    "type": "error_correction",
    "prompt": "Find and correct the error:\n'She didn't understood the question and asked the teacher to repeat it.'",
    "answer": "understand",
    "explanation": "Sau 'didn't' phải dùng V nguyên thể: 'didn't understand', không phải 'didn't understood'."
  },
  {
    "type": "transformation",
  ...
  {
    "type": "matching",
    "prompt": "Match each sentence with the use of Past Simple it demonstrates:",
    "pairs": [
      { "left": "The plane landed at 6 p.m. yesterday.", "right": "Hành động kết thúc tại thời điểm cụ thể trong QK" },
      { "left": "Shakespeare wrote 37 plays.", "right": "Sự thật lịch sử / thành tích trong QK" },
      { "left": "He opened the door, walked in, and sat down.", "right": "Chuỗi hành động liên tiếp trong QK" },
      { "left": "She lived in Paris for three years (now she's in London).", "right": "Thói quen / trạng thái trong QK, nay không còn" }
    ],
    "explanation": "Past Simple dùng cho hành động hoàn thành trong QK với thời điểm xác định, chuỗi sự kiện, hoặc trạng thái đã kết thúc."
  },
  {
    "type": "true_false_ng",
  ...
  {
    "type": "word_form",
    "prompt": "Use the correct Past Simple form:\nThe chef ___ (CHOP) the vegetables, ___ (HEAT) the pan, and ___ (FRY) everything together.",
    "answer": "chopped, heated, fried",
    "explanation": "Chuỗi hành động → Past Simple. chop → chopped (nhân đôi p). heat → heated (thêm -ed). fry → fried (y → ied)."
  }
]
-->
