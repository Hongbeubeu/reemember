...
|----------|-----------|-------|
| **Khẳng định** | `S + am/is/are + going to + V` | She **is going to start** a new job. |
| **Phủ định** | `S + am/is/are + not + going to + V` | I'**m not going to attend** the party. |
...
| # | Tình huống | Ví dụ |
|---|-----------|-------|
| 1 | **Kế hoạch, ý định đã quyết định trước** | We'**re going to move** to a new city next month. |
| 2 | **Dự đoán dựa trên bằng chứng hiện tại** | Look at those clouds — it'**s going to rain**! |
| 3 | **Điều chắc chắn xảy ra trong tương lai gần** | She'**s going to have** a baby — any day now. |
...
[
  {
    "type": "fill_blank",
    "prompt": "I've already bought the tickets. We ___ (see) the show this Saturday.",
    "answer": "are going to see",
    "explanation": "Kế hoạch đã lên sẵn (đã mua vé) → going to. 'We' → are going to + V nguyên thể."
  },
  {
    "type": "fill_blank",
    "prompt": "Watch out! That ladder ___ (fall)!",
    "answer": "is going to fall",
    "explanation": "Bằng chứng nhìn thấy ngay lúc nói (thang đang nghiêng) → going to dự đoán. 'that ladder' → is going to."
  },
  {
    "type": "multiple_choice",
    "prompt": "— Have you decided where to go on holiday?\n— Yes, we ___ to Thailand in August.",
    "options": ["will go", "are going", "are going to go", "go"],
    "answer": "are going to go",
    "explanation": "Đã quyết định trước → going to. 'We' → are going to go."
  },
  {
    "type": "multiple_choice",
    "prompt": "She just fell off her bike. She ___ hurt!",
    "options": ["will be", "is going to be", "is being", "will going to be"],
    "answer": "is going to be",
    "explanation": "Bằng chứng ngay trước mắt (vừa ngã) → dự đoán với going to, không phải will."
  },
  {
    "type": "multiple_select",
    "prompt": "Which sentences correctly use 'going to'?",
    "options": [
      "They are going to renovate the kitchen next spring.",
      "I'm going to probably agree with that.",
      "Look, the ice is cracking — he's going to fall!",
      "Are you going to applied for the job?",
      "She isn't going to attend the conference."
    ],
    "answer": ["They are going to renovate the kitchen next spring.", "Look, the ice is cracking — he's going to fall!", "She isn't going to attend the conference."],
    "explanation": "'Going to probably' → awkward; 'probably going to' là đúng. 'Applied' sau going to → phải là V nguyên thể 'apply'."
  },
  {
    "type": "reorder",
    "prompt": "Arrange the words to form a correct sentence:",
    "words": ["you", "Are", "to", "exam", "retake", "the", "going", "?"],
    "answer": "Are you going to retake the exam?",
    "explanation": "Câu hỏi: Are/Is/Am + S + going to + V nguyên thể?"
  },
  {
    "type": "error_correction",
    "prompt": "Find and correct the error:\n'She is going to visits her grandmother this weekend because she promised.'",
    "answer": "visit",
    "explanation": "Sau 'going to' phải dùng V nguyên thể: 'going to visit', không phải 'going to visits'."
  },
  {
    "type": "transformation",
    "prompt": "Complete the second sentence so it has a similar meaning, using the word given.\n\nI intend to quit my job at the end of the year.\nGOING\nI _______________ at the end of the year.",
    "answer": "am going to quit my job",
    "explanation": "'Intend to' = kế hoạch đã quyết định → am going to + V nguyên thể."
  },
  {
    "type": "matching",
    "prompt": "Match each sentence with the use of 'going to' it demonstrates:",
    "pairs": [
  ...
  {
    "type": "short_answer",
    "prompt": "What TWO uses does 'going to' have when talking about the future?",
    "answer": ["plans/intentions and predictions based on evidence", "kế hoạch và dự đoán", "intention and evidence-based prediction"],
    "explanation": "1) Kế hoạch/ý định đã quyết định trước. 2) Dự đoán dựa trên bằng chứng hiện tại có thể nhìn thấy."
  },
  {
    "type": "word_form",
    "prompt": "Use 'going to' with the correct form:\nAfter university, she ___ (TRAVEL) through Southeast Asia, and her friend ___ (JOIN) her for part of the trip.",
    "answer": "is going to travel, is going to join",
    "explanation": "Kế hoạch đã quyết định → going to. 'she/her friend' → is going to + V nguyên thể."
  }
]
-->
